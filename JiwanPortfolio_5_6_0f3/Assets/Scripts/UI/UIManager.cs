...
//		}
	...
	public void Retry()
	{
		...
		if (BundleManager.instance == null) 
		{
            ...
            SceneManager.LoadScene(curSceneName, LoadSceneMode.Single);
            //Application.LoadLevel(Application.loadedLevel); //에셋번들은 안먹힘 

		} else {

            //			AsyncOperation sceneAsync = Application.LoadLevelAsync (BundleManager.instance.currentSceneName);
            SceneManager.LoadSceneAsync(curSceneName, LoadSceneMode.Single);
